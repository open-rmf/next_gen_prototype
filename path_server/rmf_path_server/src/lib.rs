...
pub mod planner;
pub use planner::{MapfPlanner, MockPlanner, PibtPlanner, Map};
...
pub struct PathServerRunning<P: MapfPlanner> {
    ...
    pub discovery_subscription:
        rclrs::WorkerSubscription<rmf_prototype_msgs::msg::ParticipantList, DiscoveryServer<P>>,
    pub map_subscription:
        rclrs::WorkerSubscription<OccupancyGrid, PlanServer<P>>,
}
...
pub fn start_path_server<P: MapfPlanner + 'static>(
    ...
    let map_subscription = destinations_worker
        .create_subscription::<OccupancyGrid, _>(
