...
use rmf_path_server::{start_path_server, MapfPlanner, Map};
use std::sync::{Arc, Mutex};
use std::collections::HashMap;
use std::sync::atomic::AtomicBool;
use mapf_post::na::Isometry2;
use nav_msgs::msg::{Odometry, OccupancyGrid};
use rmf_prototype_msgs::msg::{Destination, ParticipantList, Participant};
...
fn test_map_subscription() -> Result<(), Box<dyn std::error::Error>> {
    ...
    dest_msg.constraints.regions.push(rmf_prototype_msgs::msg::TargetRegion {
