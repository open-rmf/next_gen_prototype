...
- `/map/source_contributions`: active cells grouped by source
...
`/map/source_contributions` publishes the active rasterized cells for each source whenever the composed map changes.
