...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('sp_demo_nav2_bringup')
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(get_package_share_directory('nav2_minimal_tb4_sim'), 'worlds', 'warehouse.sdf'),
